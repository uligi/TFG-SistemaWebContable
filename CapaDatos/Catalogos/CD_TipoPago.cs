    ...
    public class CD_TipoPago
    {
        public List<TipoPago> Listar()
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("Catalogos.sp_TipoPago_Listar", oconexion);
        ...
        public int Registrar(TipoPago obj, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.Conexion.cn))
                {
                    SqlCommand cmd = new SqlCommand("Catalogos.sp_TipoPago_Registrar", oconexion);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Editar(TipoPago obj, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.Conexion.cn))
                {
                    SqlCommand cmd = new SqlCommand("Catalogos.sp_TipoPago_Editar", oconexion);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Inactivar(int id, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.Conexion.cn))
                {
                    SqlCommand cmd = new SqlCommand("Catalogos.sp_TipoPago_Inactivar", oconexion);
                    cmd.CommandType = CommandType.StoredProcedure;
